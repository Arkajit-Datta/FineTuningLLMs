...
class ScriptArguments:
    model_name: Optional[str] = field(default="HuggingFaceH4/mistral-7b-sft-beta", metadata={"help": "the model name"})

    dataset_name: Optional[str] = field(default="ag2428/reasoningData", metadata={"help": "the dataset name"})
